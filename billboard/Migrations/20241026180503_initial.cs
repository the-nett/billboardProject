    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillboardStates", x => x.IdState);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_Permission = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Permission_ = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StateDelete = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTypePermissions", x => new { x.Id_permission, x.Id_Usertype });
                    table.ForeignKey(
